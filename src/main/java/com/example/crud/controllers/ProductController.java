...
public class ProductController {
    ...
    @GetMapping("/compararCEP")
    public ResponseEntity<Boolean> compararCEP(@RequestParam String cep, @RequestParam String productId) {
        boolean compara = viaCepService.compararCEP(cep, productId);
        return ResponseEntity.ok(compara);
    }
